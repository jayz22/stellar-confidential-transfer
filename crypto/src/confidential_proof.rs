...
pub fn prove_new_balance_range(new_balance: u128, randomness: &[Scalar; BALANCE_CHUNKS]) -> RangeProofBytes {
...
pub fn prove_transfer_amount_range(new_amount: u64, randomness: &[Scalar; AMOUNT_CHUNKS]) -> RangeProofBytes {
    // Create bulletproof generators
    let pc_gens = PedersenGens::default();
